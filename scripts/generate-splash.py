...
from og_splash_common import BG, CHALK, draw_glass, draw_text_center, load_font
...
for w, h in SIZES:
    ...
    draw_glass(d, w / 2, h * 0.44, icon)
    font = load_font(int(min(w, h) * 0.085))
    draw_text_center(d, w / 2, h * 0.44 + icon * 0.78, "고장 길잡이", font, CHALK)
